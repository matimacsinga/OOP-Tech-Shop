...
class Categories:
    ...
    @classmethod
    def remove_category(cls, cat: category.Category) -> None:
        ...
        if cat in cls.categories:
            ...
            with open('categories.txt', 'w') as f:
                for cat in cls.categories:
                    ...
                    dump(encoded_cat, f)
                    f.write('\n')
            print('Category succesfully removed')
        else:
            print('Category not in categories list')

    @classmethod
    def add_category(cls, cat: category.Category) -> None:
